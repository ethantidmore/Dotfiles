...
yay -S  aarch64-linux-gnu-gcc aerc arp-scan aws-vault b4 bind bitwarden breeze-cursors bspwm dmenu dosfstools \
	...
	perl-io-socket-ssl picom polybar prismlauncher pulsemixer python-pipx ranger swig strace sxhkd  \
	tcpdump tor torbrowser-launcher tree-sitter-cli ttf-hack-nerd ueberzugpp unclutter unzip valgrind \
	vlc wget wireshark-qt xclip xorg xorg-xinit yamllint yt-dlp zip zsh zsh-syntax-highlighting
